...
export const CloseButtonPanel = styled.div`
	width: 120px;
	height: 130px;
...
export const Title = styled.div`
    ...
    &:after {
    	...
    	width: 130px;
    	height: 130px;
		background: url(${({noTitlePicture, imgSrc}) => noTitlePicture ? '' : imgSrc || 'images/my-winnings-currency-tombola.png'}) center no-repeat;
...
export const AcceptButtonBlock = styled.div`
	width: 610px;
	height: 170px;
	background-color: #343434;
...
export const AcceptButton = styled.button`
	...
	&:before {
		...
		width: 30px;
		height: 46px;
		background: url('images/next-button_blue.png') center no-repeat;
	}
`
